...
// formuliergegevens
    ...
    return (
        <>
            <span className={styles.great}><span className={styles.picture}>
            ...
            {error && <p className="error">Dit account bestaat al. Probeer een ander emailadres.</p>}
                        ...
                        <p>Door te verzenden gaat u akkoord met de <Link to="/Requirements">Alg. Voorwaarden</Link> en <Link to="/privacy">Privacy Policy</Link></p>
