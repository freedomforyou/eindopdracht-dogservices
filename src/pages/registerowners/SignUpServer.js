...
// //                      <h1>Registratie Hondenbezitters Herokuserver</h1>
...
Role:<input
        ...
        /></label></section>
            {error && <p className="error">Dit account bestaat al. Probeer een ander emailadres.</p>}<button
                ...
                className="form-button"
                disabled={loading}>
Registreren</button><p>Door te verzenden gaat u akkoord met de <Link to="/Requirements">Alg. Voorwaarden</Link> en <Link to="/privacy">Privacy Policy</Link></p></form><p>Heb je al een account? Je kunt je <Link to="/signinserver">hier</Link> inloggen.</p></span></span></>
    );
}
export default SignUpServer;